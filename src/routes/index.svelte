...
<template>
	<main class="max-w-screen-xl mx-auto px-5">
		<section class="h-[35rem] flex flex-col justify-center items-start mt-20 md:h-[31.25rem]">
			<h1 class="text-3xl text-center font-bold text-white leading-[1.3] md:text-5xl md:text-left md:leading-[1.3]">HeadlessUI component library, but for Svelte.</h1>
			<small class="block w-full text-xs text-center font-medium text-gray-700 md:text-left">There's most likely a better way of doing this. But, it works.</small>
